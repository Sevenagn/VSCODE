...
df = pd.read_csv(r'C:\Users\seven.zhou\Downloads\test1.csv')
print(df.shape)
ds = df.to_numpy()
...
data_loader = torch.utils.data.DataLoader(dataset=my_dataset(X,Y),batch_size=10000, shuffle=True)
...
model = torch.load(r'D:\Seven\VSCODE\Python\Course\DataAnalysis\model11.pth')
