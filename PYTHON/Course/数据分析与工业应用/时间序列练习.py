...
data_loader = torch.utils.data.DataLoader(dataset=train,batch_size=100, shuffle=True)
data_loader2 = torch.utils.data.DataLoader(dataset=test,batch_size=100, shuffle=True)
