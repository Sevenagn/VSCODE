...
df = pd.read_csv(r'C:\Users\seven\OneDrive\文档\Git\GitHub\VSCODE\PYTHON\Course\数据分析与工业应用\dataset.csv')
ds = df.to_numpy()
...
model=torch.load(r'C:\Users\seven\OneDrive\文档\Git\GitHub\VSCODE\model8.pth')
for i in range(50):
    for batchX, batchY in data_loader:
        score = model(batchX)
...
torch.save(model, r'C:\Users\seven\OneDrive\文档\Git\GitHub\VSCODE\model8.pth')
